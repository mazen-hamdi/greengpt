...
import { GetWeatherResponse } from '@/lib/ai/tools/get-weather';
...
export function WeatherDisplay({ weatherData, isLoading = false }: WeatherDisplayProps) {
  if (isLoading) {
  ...
  return (
    <div className="flex flex-col items-start p-4 border rounded-lg w-full max-w-sm bg-card">
      ...
      <div className="mt-4 flex justify-between items-center w-full">
        <div className="flex flex-col">
          ...
          <span className="text-muted-foreground">{weatherData.description}</span>
        </div>
      </div>
    </div>
  );
...
function WeatherSkeleton() {
  return (
    <div className="flex flex-col items-start p-4 border rounded-lg w-full max-w-sm bg-card animate-pulse">
      <div className="flex items-center justify-between w-full">
